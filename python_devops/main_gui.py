...
Vistas ↔ paquetes:
  feed / new_article / article_detail → pkg_articles (+ tags/categories)
  article_detail (comentarios)        → pkg_comments
  users                               → pkg_users
  categories / tags                   → pkg_categories / pkg_tags
"""
...
class BlogAdminApp(ctk.CTk):
    ...
    def _build_sidebar(self, parent):
        ...
        # Create artículo → pkg_articles.create_article (+ assign_tag/category)
    ...
    def _show_article_detail(self, article):
        # Update/Delete artículo + CRUD comentarios
        self._clear_content()
